  ...
  return (
    <main className="bg-zinc-900 justify-center mt-10 flex flex-col ">
      ...
      <div className="flex items-center justify-center ">
          <div 
              className="rounded-full h-36 w-36 border bg-cover" 
      ...
      <div className="flex mt-32 justify-center gap-28 mb-27">
        <Image src={unisaLogo} height={400} width={400} alt="UniSA STEM Logo" className="mx-10"/>
        <div className="mx-10"> 
      ...
      <div className="flex mt-32 justify-center gap-56 mb-20 bg-zinc-950">
        <div className="mx-10 mt-32">
          ...
          <Image src={flindersLogo} height={350} width={350} alt="UniSA STEM Logo" className="mx-10 mt-32 mb-20"/>
