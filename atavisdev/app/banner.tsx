...
export default function Banner(){
    return(
        <div className="shadow-md" style={{ minHeight: '90vh' }} id="PurpleBarContainer">        
          <h1 className="text-center subpixel-antialiased text-white text-4xl font-extrabold mx-5 mt-20 md:mt-52">HI, I&apos;M AIDEN, AN ASPIRING SOFTWARE ENGINEER.</h1>
          <p className="text-center subpixel-antialiased text-white text-lg font-bold mt-5 mx-5 my-10">
            Recent software development graduate from the University of South Australia, passionate about crafting digital solutions.
          </p>
