...
export default function Banner(){
    return(
        ...
        <h1 className="text-center subpixel-antialiased text-white text-5xl font-extrabold sm:mx-5 mt-20 md:mt-52">HI, I&apos;M AIDEN. I ENJOY BUILDING THINGS ON THE WEB.</h1>
