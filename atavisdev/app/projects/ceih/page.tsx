...
export default function Ceih() {
    ...
    const contentData: [string, string, string[], string[]] = [
        ...
        ensure the future success of the project given that it is an ongoing student project. While remaining faithful to the original design, the 
        ...
        ensuring that future students could hit the ground running. The end product was a success and the client was very pleased with the result.`,
